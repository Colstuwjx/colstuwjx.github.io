---
title: "[ 翻译 ] 去中心化金融"
date: 2021-04-29T17:00:00+08:00
tags: ["ethereum", "defi", "translate"]
categories: ["defi"]
comments: false
showMeta: false
showAction: false
aliases:
    - /translate-ethereum-defi-doc/
---

【编者按】以太坊官方于近期在他们的官方文档里上传了一篇介绍 defi（ decentralized finance ）的文章，本文翻译自[该篇文章](https://ethereum.org/en/defi/)。

<!--more-->

DeFi 是一个为互联网时代建立的开放式全球金融系统 —— 它是那些不透明的、受到严格控制，而且杂糅了沿用了几十年之久的陈旧基础设施和流程。它让你可以控制和查看资金情况。它让你可以接触到全球市场，而且可以替代本地货币或者银行业务。只要能连上互联网，你就可以享受到 DeFi 产品开放的金融服务，而且这些服务大部分由用户自己所有和维护。到目前为止，已经有价值数百亿美元的加密货币流经 DeFi 应用，而且每天都在增长。

## 什么是 DeFi ? {#what-is-defi}

DeFi 是一组金融产品和服务的统称，任何可以使用以太坊的人（任何能连上互联网的人）都可以用上这些产品和服务。有了 DeFi，市场对用户是始终开放的，没有中央机构可以阻止付款或者拒绝用户访问任何东西。以前很慢而且可能出现人为错误的服务如今变得自动而安全，因为它们现在是通过任何人可以检查和审查的代码处理。

这里有正如日中天的加密货币经济，你可以在这里放贷，借款，做多/做空，赚取利息等等。一些精通加密货币的阿根廷人已经使用 DeFi 来规避严重的通货膨胀。一些企业已经开始实时地向他们的员工发放工资。有些人甚至拿出来通过它偿还了价值数百万美元的贷款，而无需任何个人身份证明。
...
了解 DeFi 潜力的最好办法之一就是先看看当今世界存在哪些问题。
...
- 你的个人数据会作为一些金融服务的隐形收费。

- 政府和中央机构可以随意关闭市场。

- 交易时间通常限定于特定时区的营业时间。

- 由于需要一些内部的人工流程，一次汇款可能需要花几天时间。

- 金融服务会有一些溢价，因为中介会从中抽成。

### 一个对比 {#defi-comparison}

| DeFi                                                                                               | 传统金融                                                                                                           |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| 你自己管自己的钱                                                                               | 你的钱托管给了某些企业                                                                                               |
| 你可以控制钱的去向和使用途径           |  你必须信任这些企业不会管理不善，比如放贷给那些有风险的借款人那样                                      |
| 资金转账几分钟内搞定                                                             | 由于存在人工流程，支付可能需要花几天的时间                                                                             |
| 交易活动是匿名的           |  金融活动与个人身份密切相关                            |
| DeFi 可以对任何人开放                                                                           | 你必须申请使用对应的金融服务                                                                       |
| 市场总是对外开放的                                                                      | 由于员工需要休息，会有闭市                |
|  它建立在透明的基础之上 —— 任何人都可以查看该产品的数据并检查系统是如何工作的 | 金融机构是封闭的账簿：你无法要求查看它们的贷款历史记录，管理资产的记录等等  |

[探索一下 DeFi 应用](/dapps/?category=finance)

## 它始于比特币... {#bitcoin}

从许多方面来说，比特币都可以算的上是第一个 DeFi 应用。比特币让你可以真正拥有和控制价值，并且可以将它传遍世界各地。它独辟蹊径，使得原本彼此并不信任的一群人可以在不需要可靠的中介机构的情况下就账户账本达成共识。比特币对任何人都是开放的，没有人可以有权限更改其规则。比特币的规则，例如它的稀缺性和开放性，已经被写入到了技术实现里。不同于传统金融，政府可以印钞让居民的存款贬值，而公司则可以停牌。

以太坊以此为基石，就像比特币那样，每个人都可以访问，但是却无法修改它的规则。然而，这也让这一数字货币得以使用[智能合约](/glossary#smart-contract)编程，因此你能做的不仅仅只是储蓄和转账。
...
这听上去可能很奇怪... "为什么我要给我的钱写程序？" 然而，这仅仅只是以太坊 token 默认自带的功能而已。任何人都可以把逻辑编码到支付里。因此，你可以既享受金融机构提供的诸多服务，又可以得到比特币的可控性和安全性。这允许用户使用加密货币做一些比特币无法做到的事情，比如借贷，安排付款，投资指数基金等等。

如果你不熟悉以太坊的话，不妨来看看我们关于试用 DeFi 应用给出的一些建议。
[探索一下 DeFi 应用](/dapps/?category=finance)

## 你可以用 DeFi 做些什么？ {#defi-use-cases}

这是一项针对绝大多数金融服务的去中心化的替代方案。但是以太坊也为打造那些全新的金融产品创造了许多机会。以下是一个清单（持续扩充）：
